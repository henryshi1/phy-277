...
where q is the charge density. This can be discretized and solved via relaxation by the iterative equation in the document `assignment08.pdf` in the **assignment_desc** folder.
